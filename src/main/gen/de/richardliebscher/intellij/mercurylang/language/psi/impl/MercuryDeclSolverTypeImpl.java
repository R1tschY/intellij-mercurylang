...
public class MercuryDeclSolverTypeImpl extends ASTWrapperPsiElement implements MercuryDeclSolverType {

  public MercuryDeclSolverTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MercuryVisitor visitor) {
    visitor.visitDeclSolverType(this);
  }
