...
public class MercuryMinusTermImpl extends MercuryTermImpl implements MercuryMinusTerm {

  public MercuryMinusTermImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull MercuryVisitor visitor) {
    visitor.visitMinusTerm(this);
  }
