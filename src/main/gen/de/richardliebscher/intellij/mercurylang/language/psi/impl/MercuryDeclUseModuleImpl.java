...
public class MercuryDeclUseModuleImpl extends ASTWrapperPsiElement implements MercuryDeclUseModule {

  public MercuryDeclUseModuleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MercuryVisitor visitor) {
    visitor.visitDeclUseModule(this);
  }
