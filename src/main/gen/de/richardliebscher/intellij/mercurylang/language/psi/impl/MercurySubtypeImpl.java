...
public class MercurySubtypeImpl extends ASTWrapperPsiElement implements MercurySubtype {

  public MercurySubtypeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public MercuryTypeRef getTypeRef() {
    return findNotNullChildByClass(MercuryTypeRef.class);
  }
