...
public class MercuryBoolAndTermImpl extends MercuryTermImpl implements MercuryBoolAndTerm {

  public MercuryBoolAndTermImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull MercuryVisitor visitor) {
    visitor.visitBoolAndTerm(this);
  }
