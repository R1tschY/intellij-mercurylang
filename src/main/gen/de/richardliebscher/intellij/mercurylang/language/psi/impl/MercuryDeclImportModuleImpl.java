...
public class MercuryDeclImportModuleImpl extends ASTWrapperPsiElement implements MercuryDeclImportModule {

  public MercuryDeclImportModuleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MercuryVisitor visitor) {
    visitor.visitDeclImportModule(this);
  }
  ...
  @Override
  @Nullable
  public MercuryModuleList getModuleList() {
    return findChildByClass(MercuryModuleList.class);
  }
