...
public class MercuryImplicationGoalImpl extends MercuryGoalImpl implements MercuryImplicationGoal {

  public MercuryImplicationGoalImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull MercuryVisitor visitor) {
    visitor.visitImplicationGoal(this);
  }
