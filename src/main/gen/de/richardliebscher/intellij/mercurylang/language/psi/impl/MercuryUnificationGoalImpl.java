...
public class MercuryUnificationGoalImpl extends MercuryGoalImpl implements MercuryUnificationGoal {

  public MercuryUnificationGoalImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull MercuryVisitor visitor) {
    visitor.visitUnificationGoal(this);
  }
