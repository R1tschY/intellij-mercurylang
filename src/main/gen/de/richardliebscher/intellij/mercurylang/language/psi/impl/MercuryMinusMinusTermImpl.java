...
public class MercuryMinusMinusTermImpl extends MercuryTermImpl implements MercuryMinusMinusTerm {

  public MercuryMinusMinusTermImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull MercuryVisitor visitor) {
    visitor.visitMinusMinusTerm(this);
  }
