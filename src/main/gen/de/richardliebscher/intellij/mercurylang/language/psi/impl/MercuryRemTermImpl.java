...
public class MercuryRemTermImpl extends MercuryTermImpl implements MercuryRemTerm {

  public MercuryRemTermImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull MercuryVisitor visitor) {
    visitor.visitRemTerm(this);
  }
