...
public class MercuryIfThenElse2GoalImpl extends MercuryGoalImpl implements MercuryIfThenElse2Goal {

  public MercuryIfThenElse2GoalImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull MercuryVisitor visitor) {
    visitor.visitIfThenElse2Goal(this);
  }
