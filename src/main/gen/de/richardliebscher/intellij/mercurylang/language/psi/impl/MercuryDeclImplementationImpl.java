...
public class MercuryDeclImplementationImpl extends ASTWrapperPsiElement implements MercuryDeclImplementation {

  public MercuryDeclImplementationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MercuryVisitor visitor) {
    visitor.visitDeclImplementation(this);
  }
