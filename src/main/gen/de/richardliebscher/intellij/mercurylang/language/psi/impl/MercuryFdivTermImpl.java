...
public class MercuryFdivTermImpl extends MercuryTermImpl implements MercuryFdivTerm {

  public MercuryFdivTermImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull MercuryVisitor visitor) {
    visitor.visitFdivTerm(this);
  }
