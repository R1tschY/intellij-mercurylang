...
public class MercuryTypeRefImpl extends ASTWrapperPsiElement implements MercuryTypeRef {

  public MercuryTypeRefImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public MercuryVariableList getVariableList() {
    return findChildByClass(MercuryVariableList.class);
  }
