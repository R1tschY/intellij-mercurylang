...
public class MercuryConjunctionGoalImpl extends MercuryGoalImpl implements MercuryConjunctionGoal {

  public MercuryConjunctionGoalImpl(@NotNull ASTNode node) {
    super(node);
  }
