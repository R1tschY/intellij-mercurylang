...
public class MercuryModuleListImpl extends ASTWrapperPsiElement implements MercuryModuleList {

  public MercuryModuleListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MercuryVisitor visitor) {
    visitor.visitModuleList(this);
  }
  ...
  @Override
  @NotNull
  public List<MercuryQname> getQnameList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, MercuryQname.class);
  }
