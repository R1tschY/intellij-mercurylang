...
public class MercuryDiscriminatedUnionImpl extends ASTWrapperPsiElement implements MercuryDiscriminatedUnion {

  public MercuryDiscriminatedUnionImpl(@NotNull ASTNode node) {
    super(node);
  }
