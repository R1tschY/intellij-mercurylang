...
public class MercuryRightShiftTermImpl extends MercuryTermImpl implements MercuryRightShiftTerm {

  public MercuryRightShiftTermImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull MercuryVisitor visitor) {
    visitor.visitRightShiftTerm(this);
  }
