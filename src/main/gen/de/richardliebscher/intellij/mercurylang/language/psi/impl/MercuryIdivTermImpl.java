...
public class MercuryIdivTermImpl extends MercuryTermImpl implements MercuryIdivTerm {

  public MercuryIdivTermImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull MercuryVisitor visitor) {
    visitor.visitIdivTerm(this);
  }
