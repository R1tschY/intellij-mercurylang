...
public class MercuryVariableListImpl extends ASTWrapperPsiElement implements MercuryVariableList {

  public MercuryVariableListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<MercuryVariableTerm> getVariableTermList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, MercuryVariableTerm.class);
  }
