...
public class MercuryDeclPredImpl extends ASTWrapperPsiElement implements MercuryDeclPred {

  public MercuryDeclPredImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MercuryVisitor visitor) {
    visitor.visitDeclPred(this);
  }
  ...
  @Override
  @Nullable
  public MercuryDeclArgumentList getDeclArgumentList() {
    return findChildByClass(MercuryDeclArgumentList.class);
  }

  @Override
  @Nullable
  public MercuryDeterminismCategory getDeterminismCategory() {
    return findChildByClass(MercuryDeterminismCategory.class);
  }
