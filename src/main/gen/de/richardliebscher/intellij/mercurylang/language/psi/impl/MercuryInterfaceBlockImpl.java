...
public class MercuryInterfaceBlockImpl extends ASTWrapperPsiElement implements MercuryInterfaceBlock {

  public MercuryInterfaceBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public MercuryDeclInterface getDeclInterface() {
    return findNotNullChildByClass(MercuryDeclInterface.class);
  }
