...
public class MercuryLeftShiftTermImpl extends MercuryTermImpl implements MercuryLeftShiftTerm {

  public MercuryLeftShiftTermImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull MercuryVisitor visitor) {
    visitor.visitLeftShiftTerm(this);
  }
