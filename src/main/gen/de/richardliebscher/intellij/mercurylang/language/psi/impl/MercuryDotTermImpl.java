...
public class MercuryDotTermImpl extends MercuryTermImpl implements MercuryDotTerm {

  public MercuryDotTermImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull MercuryVisitor visitor) {
    visitor.visitDotTerm(this);
  }
