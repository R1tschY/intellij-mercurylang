...
public class MercuryIfThenElse1GoalImpl extends MercuryGoalImpl implements MercuryIfThenElse1Goal {

  public MercuryIfThenElse1GoalImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull MercuryVisitor visitor) {
    visitor.visitIfThenElse1Goal(this);
  }
