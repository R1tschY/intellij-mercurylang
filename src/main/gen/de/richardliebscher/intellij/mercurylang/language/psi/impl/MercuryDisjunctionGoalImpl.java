...
public class MercuryDisjunctionGoalImpl extends MercuryGoalImpl implements MercuryDisjunctionGoal {

  public MercuryDisjunctionGoalImpl(@NotNull ASTNode node) {
    super(node);
  }
