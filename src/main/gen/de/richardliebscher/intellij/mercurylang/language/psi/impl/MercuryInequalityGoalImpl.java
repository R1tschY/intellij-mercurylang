...
public class MercuryInequalityGoalImpl extends MercuryGoalImpl implements MercuryInequalityGoal {

  public MercuryInequalityGoalImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull MercuryVisitor visitor) {
    visitor.visitInequalityGoal(this);
  }
