...
public class MercuryBoolOrTermImpl extends MercuryTermImpl implements MercuryBoolOrTerm {

  public MercuryBoolOrTermImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull MercuryVisitor visitor) {
    visitor.visitBoolOrTerm(this);
  }
