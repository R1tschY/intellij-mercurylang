...
public class MercuryReverseImplicationGoalImpl extends MercuryGoalImpl implements MercuryReverseImplicationGoal {

  public MercuryReverseImplicationGoalImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull MercuryVisitor visitor) {
    visitor.visitReverseImplicationGoal(this);
  }
