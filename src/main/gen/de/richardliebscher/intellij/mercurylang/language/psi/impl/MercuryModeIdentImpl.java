...
public class MercuryModeIdentImpl extends ASTWrapperPsiElement implements MercuryModeIdent {

  public MercuryModeIdentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MercuryVisitor visitor) {
    visitor.visitModeIdent(this);
  }
  ...
  public MercuryQname getQname() {
    return findNotNullChildByClass(MercuryQname.class);
  }
