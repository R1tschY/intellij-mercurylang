...
public class MercuryExclamationTermImpl extends MercuryTermImpl implements MercuryExclamationTerm {

  public MercuryExclamationTermImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull MercuryVisitor visitor) {
    visitor.visitExclamationTerm(this);
  }
  ...
  public MercuryTerm getTerm() {
    return findChildByClass(MercuryTerm.class);
  }
