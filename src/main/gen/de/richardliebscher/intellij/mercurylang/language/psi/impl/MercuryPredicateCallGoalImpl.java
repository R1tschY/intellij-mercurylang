...
public class MercuryPredicateCallGoalImpl extends MercuryGoalImpl implements MercuryPredicateCallGoal {

  public MercuryPredicateCallGoalImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull MercuryVisitor visitor) {
    visitor.visitPredicateCallGoal(this);
  }
