...
public class MercuryDeclModuleImpl extends ASTWrapperPsiElement implements MercuryDeclModule {

  public MercuryDeclModuleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MercuryVisitor visitor) {
    visitor.visitDeclModule(this);
  }
