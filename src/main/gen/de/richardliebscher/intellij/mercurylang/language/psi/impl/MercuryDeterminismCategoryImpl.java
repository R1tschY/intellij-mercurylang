...
public class MercuryDeterminismCategoryImpl extends ASTWrapperPsiElement implements MercuryDeterminismCategory {

  public MercuryDeterminismCategoryImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MercuryVisitor visitor) {
    visitor.visitDeterminismCategory(this);
  }
